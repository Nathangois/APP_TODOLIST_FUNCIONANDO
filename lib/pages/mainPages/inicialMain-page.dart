  ...
  static final lightTheme = ThemeData(
    ...
    extensions: <ThemeExtension<dynamic>>[
      CustomColors(
        ...
        floatingActionButtonColor:
            const Color.fromARGB(255, 255, 102, 14), // Cor do FAB no tema claro
        ...
        cardBackgroundTaskColor: const Color.fromARGB(
            255, 222, 171, 142), // Cor do TaskCard no tema claro
      ),
      CustomButtonStyles(
  ...
  static final darkTheme = ThemeData(
    ...
    extensions: <ThemeExtension<dynamic>>[
      CustomColors(
        ...
        cardBackgroundColor:
            const Color.fromARGB(255, 95, 92, 90), // Cor do Card no tema escuro
        cardBackgroundTaskColor: const Color.fromARGB(
            255, 43, 42, 42), // Cor do TaskCard no tema escuro
      ),
      CustomButtonStyles(
        dialogButtonStyle: TextButton.styleFrom(
          backgroundColor: const Color.fromARGB(255, 255, 102, 14),
...
class _InicialMainPageState extends State<InicialMainPage> {
  ...
  Future<void> deleteReminder(String reminderId) async {
    try {
      final url = Uri.parse(
          'https://api-nodejs-a3.onrender.com/api/lembretes/$userId/$reminderId');
  ...
  Future<void> deleteTask(String taskId) async {
    try {
      final url = Uri.parse(
          'https://api-nodejs-a3.onrender.com/api/tarefas/$userId/$taskId');
      final response = await http.delete(url);
  ...
  Future<void> fetchReminders() async {
    ...
    try {
      final response = await http.get(Uri.parse(
          'https://api-nodejs-a3.onrender.com/api/lembretes/$userId'));
  ...
  Future<void> fetchTasks() async {
    ...
    try {
      final response = await http.get(
          Uri.parse('https://api-nodejs-a3.onrender.com/api/tarefas/$userId'));
